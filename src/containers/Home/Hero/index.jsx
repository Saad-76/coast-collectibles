      ...
      <div className="background-image-home-section">
        <div className="row ">
          ...
          <div className="promo-section">
                  ...
                  <div className="dream-btn-group button-main-style">
                    <div className="buton-style-store mr-3">
                      {/* Explore More */}
                      <h4 className="text-homepage-style">Coming Soon</h4>
                      <img src={AppleStore} alt="AppleStore" height="200px" width="200px"/>
                    </div>
                    <div className="buton-style-store ">
                      {/* Collect NFT{" "} */}
                      <h4 className="text-homepage-style">Coming Soon</h4>
