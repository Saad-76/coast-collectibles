...
<>
    ...
    <div className="container-style-faq">
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
            Once the asset is authenticated it is then fractionalised and minted
            as NFTs. The asset will cease to exist.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
            ...
            This enables the network to store the information that is indicated
            in an NFT transaction. This information can be accessed when needed.
            The smart contract also ensures that the information stored is
            transparent as well as immutable.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
